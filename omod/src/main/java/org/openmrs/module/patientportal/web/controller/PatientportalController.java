 ...
 * 'module/patientportal/patientportalLink.form'.
 */
@Controller("${rootrootArtifactId}.PatientportalController")
@RequestMapping(value = "module/patientportal/patientportal.form")
public class PatientportalController {
	...
	private final String VIEW = "/module/patientportal/patientportal";
	 ...
	 * 
	 */
	@RequestMapping(value = "/module/patientportal/addDepartment", method = RequestMethod.POST)
	public String submitDepartment(WebRequest request, HttpSession httpSession, ModelMap model,
		...
		if (!Context.isAuthenticated()) {
			...
			try {
				...
				httpSession.setAttribute(WebConstants.OPENMRS_ERROR_ATTR, "department.delete.success");
