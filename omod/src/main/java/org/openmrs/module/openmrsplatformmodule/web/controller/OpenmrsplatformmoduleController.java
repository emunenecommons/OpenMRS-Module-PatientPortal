 ...
 */
package org.openmrs.module.openmrsplatformmodule.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.OpenmrsplatformmoduleController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class OpenmrsplatformmoduleController {
